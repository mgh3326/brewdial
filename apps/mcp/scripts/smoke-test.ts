...
async function smokeTest(): Promise<void> {
  ...
  try {
    ...
    if (toolsResult.tools.length !== 2) {
      throw new Error(`Expected 2 tools, got ${toolsResult.tools.length}`);
    }
    ...
    console.log('\n2. Testing brew.get_recent_context (expecting CouchDB error)...');
    ...
    console.log('\n3. Testing brew.get_recipe_context with invalid code...');
    ...
    console.log('\n4. Testing brew.get_recipe_context with valid code...');
