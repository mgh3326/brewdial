...
class Recipe {
    ...
    @Column(name = "params", nullable = false, columnDefinition = "jsonb", insertable = false, updatable = false)
    var params: String = "{}"

    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "steps", nullable = false, columnDefinition = "jsonb", insertable = false, updatable = false)
    var steps: String = "[]"
    ...
    @Column(name = "is_official", nullable = false, insertable = false, updatable = false)
